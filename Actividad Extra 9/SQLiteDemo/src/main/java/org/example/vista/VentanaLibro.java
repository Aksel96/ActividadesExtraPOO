...
public class VentanaLibro extends JFrame {
    ...
    private JPanel panel1; //capturar libros
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(250, 177, 177));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(177, 239, 250));
        ...
        panel3.setBackground(new Color(177, 250, 187));

        //panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(210, 177, 250));
